...
function renderSaldo() {
    ...
    const now = new Date();
    dom.rangeText.textContent = `${bulan[now.getMonth()]} ${now.getFullYear()}`;
    dom.btnFilterPeriod.innerHTML = `<i class="fas fa-calendar"></i> ${bulan[now.getMonth()]} ${now.getFullYear()}`;
}

// ================================================================
//  RENDER HISTORY (dengan tombol hapus & edit)
// ================================================================
            ...
            <div class="row" data-id="${t.id}">
                ...
                <span style="display:flex;align-items:center;gap:8px;justify-content:space-between;">
                    ...
                    <div style="display:flex;gap:4px;">
                        <button class="edit-btn" data-id="${t.id}" title="Edit" style="background:none;border:none;color:var(--text-secondary);cursor:pointer;font-size:14px;transition:0.2s;">
                            <i class="fas fa-pen"></i>
                        </button>
                        <button class="delete-btn" data-id="${t.id}" title="Hapus" style="background:none;border:none;color:var(--text-secondary);cursor:pointer;font-size:14px;transition:0.2s;">
        ...
        html += `
            <div class="row" style="grid-template-columns:2fr 1.2fr 1fr 1.2fr;">
                ...
                <span style="display:flex;align-items:center;gap:8px;justify-content:space-between;">
                    <span style="color:${color};font-weight:700;">${sign} Rp${formatRupiah(t.nominal)}</span>
                    <div style="display:flex;gap:4px;">
                        <button class="edit-btn-all" data-id="${t.id}" title="Edit" style="background:none;border:none;color:var(--text-secondary);cursor:pointer;font-size:14px;transition:0.2s;">
                            <i class="fas fa-pen"></i>
                        </button>
                        <button class="delete-btn-all" data-id="${t.id}" title="Hapus" style="background:none;border:none;color:var(--text-secondary);cursor:pointer;font-size:14px;transition:0.2s;">
                            <i class="fas fa-trash"></i>
                        </button>
                    </div>
                </span>
